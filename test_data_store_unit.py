...
from src.config.data_store import _determine_file_extension
from src.config.data_store import _save_json_data
...
def test_determine_file_extension_with_document_list():
    ...
    docs = [Document(text="Test document 1", doc_id="doc1"), Document(text="Test document 2", doc_id="doc2")]
...
def test_save_json_data_with_document_list():
    ...
    docs = [
        Document(text="First document", doc_id="doc1", metadata={"source": "test1.py"}),
        Document(text="Second document", doc_id="doc2", metadata={"source": "test2.py"}),
    ]
...
def test_save_json_data_with_single_document():
    ...
    doc = Document(text="Single test document", doc_id="single_doc", metadata={"source": "single.py"})
...
def test_save_document_list_integration():
    ...
    docs = [
        Document(text="Integration test document 1", doc_id="int_doc1", metadata={"source": "integration1.py"}),
        Document(text="Integration test document 2", doc_id="int_doc2", metadata={"source": "integration2.py"}),
    ]

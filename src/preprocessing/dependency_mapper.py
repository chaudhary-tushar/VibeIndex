...
class DependencyMapper:
    ...
    def extract_dependencies(self, code: str, language: str, symbol_index: dict | None = None) -> list[str]:
    ...
    def _extract_python_symbol_usage(self, code: str, symbol_index: dict | None = None) -> set[str]:
    ...
    def _extract_js_symbol_usage(self, code: str, symbol_index: dict | None = None) -> set[str]:

...
class Reranker:
    ...
    def rerank(self, query: str, candidates: list[dict], context: dict | None = None) -> list[dict]:
        """
        ...
        scores = {"keyword_relevance": relevance_scores, "vector_similarity": semantic_scores}
        ...
        qa_semantic_scores = self.semantic_similarity.calculate_similarity_from_text(
            query, [pc["text"] for pc in processed_for_qa]
        )
